...
export default class AdminOrder extends Component {
    ...
    async handleOpen() {
        const response = await axios({
            method: 'GET',
            url: 'http://localhost:8000/order/' + this.state.orderInfo.order_id + '/lines'
        });
    ...
    async delivery() {
        const response = await axios({
            method: 'POST',
            url: 'http://localhost:8000/order/delivery/' + this.state.orderInfo.order_id
        });
    ...
    async deliveryRollBack() {
        const response = await axios({
            method: 'POST',
            url: 'http://localhost:8000/order/delivery/' + this.state.orderInfo.order_id + '/rollback'
        });
